...
(function () {
  var newMessageTextInp = document.getElementById('new-message-text'),
    ...
    if (newMessageTextInp.value !== '') {
      messageTemplate.content.querySelector('.message-text').textContent = newMessageTextInp.value;
  ...
  var current = -1;
  newMessageTextInp.addEventListener('keyup', function (event) {
  ...
  messageDisableBtn.addEventListener('click', function () {
    var messages = messageList.querySelectorAll('.message:not(.disabled)');
